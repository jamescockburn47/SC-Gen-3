...
class MultiAgentRAGOrchestrator:
    ...
    def _create_document_analysis_strategy(self) -> Dict[str, Any]:
        return {
            'prompt_template': """Analyze the following documents to provide a comprehensive overview in response to: {query}
...
4. Important relationships between different sections

Focus on accuracy and cite specific sources for each point.""",
            'temperature': 0.1,
...
Provide a comprehensive cross-analysis.""",
    ...
    def _create_synthesis_strategy(self) -> Dict[str, Any]:
        return {
            'prompt_template': """Synthesize all previous analysis to provide a comprehensive answer to: {query}

Based on the document analysis, consider all aspects:
- Legal implications
- Risk factors  
...
Provide a well-structured, comprehensive response that integrates all relevant findings.""",
            'temperature': 0.2,
